(function () {
  ...
  function addGame(e) {
    ...
    if (playersName[0] !== '') newResult.querySelectorAll('.player span')[0].textContent = playersName[0];
    if (playersName[1] !== '') newResult.querySelectorAll('.player span')[1].textContent = playersName[1];
